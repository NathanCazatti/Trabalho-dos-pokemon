document.addEventListener('DOMContentLoaded', async () => {
  ...
  try {
      const ghostTypeResponse = await fetch('https://pokeapi.co/api/v2/type/14/');
      const ghostTypeData = await ghostTypeResponse.json();
      
      const ghostPokemon = ghostTypeData.pokemon.slice(0, 136);
      ...
      loadingElement.textContent = 'Failed to summon the psychics. Try again later!';
