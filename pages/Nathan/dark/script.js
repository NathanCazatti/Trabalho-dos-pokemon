document.addEventListener('DOMContentLoaded', async () => {
  ...
  try {
      const ghostTypeResponse = await fetch('https://pokeapi.co/api/v2/type/17/');
      const ghostTypeData = await ghostTypeResponse.json();
      
      const ghostPokemon = ghostTypeData.pokemon.slice(0, 94);
      ...
      loadingElement.textContent = 'Failed to summon the shadows. Try again later!';
