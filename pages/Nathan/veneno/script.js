document.addEventListener('DOMContentLoaded', async () => {
  ...
  try {
      const ghostTypeResponse = await fetch('https://pokeapi.co/api/v2/type/4/');
      const ghostTypeData = await ghostTypeResponse.json();
      
      const ghostPokemon = ghostTypeData.pokemon.slice(0, 102);
      ...
      loadingElement.textContent = 'Failed to survive the venomous animals.';
