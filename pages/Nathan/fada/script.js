document.addEventListener('DOMContentLoaded', async () => {
  ...
  try {
      const ghostTypeResponse = await fetch('https://pokeapi.co/api/v2/type/18/');
      const ghostTypeData = await ghostTypeResponse.json();
      
      const ghostPokemon = ghostTypeData.pokemon.slice(0, 83);
      ...
      loadingElement.textContent = 'Failed to summon the fairies. Try again later!';
